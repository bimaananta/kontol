...
<body class="flex flex-row relative p-0 m-0 overflow-x-hidden">
    ...
    <div class="container flex-1 h-screen relative flex flex-col">
        ...
        <div class="main flex-1 p-5 px-10">
            <div class="header mb-3 flex flex-row justify-between items-center">
                <div class="left-side">
                    ...
                    <p class="text-slate-600">Lihat dan kelola pengguna manajemen inevntaris</p>
                </div>
            ...
            <div class="w-full h-fit rounded-md p-3 mb-3 grid grid-cols-2 gap-2">
                <div class="sort-part flex flex-row items-center w-fit gap-3">
                ...
                <div class="w-full h-full flex flex-row justify-end items-center row-span-2">
                    <a href="accept-pending.php" class="px-3 py-2 bg-yellow-500 rounded-md text-white flex flex-row gap-2 items-center relative">
                        Menunggu Disetujui...
                        <div class="p-2 box-border w-[5px] h-[5px] text-sm rounded-full bg-red-600 text-white flex flex-row justify-center items-center absolute -top-1 -right-1"></div>
                        <div class="p-2 box-border w-[5px] h-[5px] text-sm rounded-full bg-red-600 text-white flex flex-row justify-center items-center absolute -top-1 -right-1 animate-ping"></div>
                    </a>
                </div>
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        <td>1</td>
                        <td>Bima Ananta</td>
                        <td>albaihaqibimaananta"gmail.com</td>
                        <td>bimaananta</td>
                        <td>Admin</td>
