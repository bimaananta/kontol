...
<body class="flex flex-row relative">
    <div class="sidebar sidebar-non-active p-6 box-border shadow-md min-w-[300px] h-[100vh] bg-slate-800 text-white transition-all fixed left-0 md:static z-50" id="sidebar">
        ...
        <div class="navigation mt-5 flex flex-col">
            ...
            <a href="history.php" class="navbar active geography p-2 flex flex-row items-center gap-3 mt-2"">
        ...
        <div class="main flex-1 p-5 px-10">
            <div class="header mb-3 flex flex-row justify-between items-center">
                <div class="left-side">
                    ...
                    <p class="text-slate-600">Lihat dan kelola histori penambahan dan penukaran alat</p>
                </div>
                <div class="right-side flex flex-row items-center gap-3">
                    ...
                    <div class="profile-detail">
                        ...
                        <p class="text-smtext-slate-600">View Profile</p>
                    </div>
                </div>
            </div>
            <div class="history-collection w-full h-fit grid grid-cols-1">
                <div class="history-card w-full h-fit bg-white rounded-mds shadow-md p-3">
                    ...
                    <div class="action flex flex-row justify-between gap-2 mt-5">
                        <button class="px-3 py-2 flex-1 text-white rounded-md bg-blue-500 filter transition-all hover:brightness-90"><i class="bi bi-info-circle"></i> Detail</button>                    
                        <button class="px-3 py-2 flex-1 text-white rounded-md bg-red-500 filter transition-all hover:brightness-90"><i class="bi bi-trash"></i> Hapus</button>                    
                    </div>
                </div>
            </div>
        </div>
